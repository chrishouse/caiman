...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-60989019-2"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', 'UA-60989019-2');
	</script>
	...
	<script type="application/ld+json">
	{
	  ...
	  "name": "Caiman Web Design",
	  "image": "https://caimanwebdesign.com/wp-content/uploads/2018/06/caiman-logo.png",
	  "@id": "",
	  "url": "https://caimanwebdesign.com",
	  "telephone": "9137356466",
	  ...
	  "sameAs": [
	    "https://www.facebook.com/caimanwebdesign",
	    "https://www.twitter.com/caimanwebdesign",
	    "https://plus.google.com/b/107119314765810779042/communities/111595890892525407637"
	  ]
	}
	</script>
</head>
...
<div id="page" class="site">
	<header id="masthead" class="site-header clearfix">
		<div class="inner">
			...
			<a href="/contact" class="button button-orange button-contact-header button-contact-header-non-mobile">Get a Quote - Contact&nbsp;&nbsp;&nbsp;<i class="fas fa-chevron-right"></i></a>

			<div class="mobile-icon"><i class="fas fa-bars"></i> <a href="/contact" class="button button-orange button-contact-header">Get a Quote - Contact&nbsp;&nbsp;&nbsp;<i class="fas fa-chevron-right"></i></a></div>
		</div>
	</header><!-- #masthead -->
